    ...
    if update.message:
        ...
        if text.startswith("/start"):
            ...
            if reminder_time:
                ...
                await bot.send_message(chat_id=chat_id, text="❌ I couldn't understand the time you provided. Please try again.")
        ...
        if data == "show_todos":
            ...
            await bot.send_message(chat_id=chat_id, text="🌦️ Please type `/weather CityName` to get the weather!")
